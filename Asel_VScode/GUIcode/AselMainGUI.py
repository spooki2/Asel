...
class AselMainGUI(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Asel,userLookup,sendMessage,refreshLite,callRequest,checkIfCalled):
        ...
        self.camFrame = QtWidgets.QFrame(self.mainPage)
        ...
        self.muteButton = QtWidgets.QPushButton(self.mainPage)
        ...
        self.cameraButton = QtWidgets.QPushButton(self.mainPage)
        ...
        self.avatarButton = QtWidgets.QPushButton(self.mainPage)
        self.avatarButton.setGeometry(QtCore.QRect(270, 380, 51, 51))
        self.avatarButton.setToolTip("")
        self.avatarButton.setStyleSheet(CSSdata.utilityButtonCSS)
        self.avatarButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("GUIcode/icons/avatar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.avatarButton.setIcon(icon4)
        self.avatarButton.setObjectName("avatarButton")
        self.horizontalSlider = QtWidgets.QSlider(self.mainPage)
        self.horizontalSlider.setGeometry(QtCore.QRect(10, 390, 251, 31))
